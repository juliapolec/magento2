...
class UpdateTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    {
        return [
            ['shipping', true, 21.0, 10.0, 2.00, true],
            ['shipping', false, 21.0, 10.0, 2.00, true],
            ['shipping', true, 21.0, 10.0, 2.00, false],
            ['shipping', false, 21.0, 10.0, 2.00, false],
            ['shipping', false, 10.0, 25.5, 2.11, false],
            ['shipping', false, 0, 10.0, 5.00, false],
            ['shipping', false, 10.0, 0, 5.00, false],
            ['shipping', false, 0, 0, 10.00, false],
            ['shipping', false, 10.0, 10.0, 20.00, false],
            ['billing', true, 21.0, 10.0, 2.00, true],
            ['billing', false, 21.0, 10.0, 2.00, true],
            ['billing', true, 21.0, 10.0, 2.00, false],
            ['billing', false, 21.0, 10.0, 2.00, false],
        ];
    }
