...
QUERY;
        ...
        $responseItems = $negotiableQuoteResponse['items'];
        ...
        // verify prices
        $this->assertEquals($snapshotQuote->getGrandTotal(), $negotiableQuoteResponse['prices']['grand_total']['value']);
...
QUERY;
    ...
    {
        $negotiableQuoteIds = $includeQuoteIds ? $this->generateMaskedQuoteIdsForCustomer('email@companyquote.com') : [];
    ...
    public function dataProviderNegotiableQuoteSortOrder(): array
    {
        return [
            'sort_asc_by_name' => [
                'QUOTE_NAME',
                'ASC',
                ['nq_one', 'nq_three', 'nq_two', 'quote_customer_send']
            ],
            'sort_desc_by_name' => [
                'QUOTE_NAME',
                'DESC',
                ['quote_customer_send', 'nq_two', 'nq_three', 'nq_one']
            ]
        ];
    }
